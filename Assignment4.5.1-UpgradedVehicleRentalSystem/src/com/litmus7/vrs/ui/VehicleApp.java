	...
	public static void main(String[] args) {
		...
		while (!exit) {
			...
			case 1:
				...
				List<Vehicle> allVehicles = allResponse.getData();
			...
			case 2:
				...
				Response<Void> rentResponse = controller.rentVehicle(rentId);
			...
			case 3:
				...
				Response<Void> returnResponse = controller.returnVehicle(returnId);
			...
			case 4:
				...
				if (type.equalsIgnoreCase("Car")) {
					...
					scanner.nextLine();
					newVehicle = new Car(brand, model, price, doors, isAutomatic);
					...
					scanner.nextLine();
					newVehicle = new Bike(brand, model, price, hasGear, cc);
				} else {
					System.out.println("Invalid vehicle type.");
					break;
				}

				Response<Void> addResponse = controller.addVehicle(newVehicle);
			...
			case 5:
				...
				Response<List<Vehicle>> searchResponse = controller.searchVehicleByModel(searchModel);
				if (searchResponse.getStatusCode() == Response.SUCCESS_FILE_RETRIEVED) {
					List<Vehicle> found = searchResponse.getData();
			...
			case 6:
				...
				System.out.println("Total rental price of all vehicles: " + totalResponse.getData());
				break;
